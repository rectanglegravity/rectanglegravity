import {
  require_jsx_runtime
} from "./chunk-FHBBZ3IW.js";
import {
  require_react_dom
} from "./chunk-SNV3AFIN.js";
import {
  __commonJS,
  __toESM,
  require_object_assign,
  require_react
} from "./chunk-V3QZ3CYN.js";
...
function useButton(parameters) {
  ...
  const updateHostElementName = React24.useCallback((instance) => {
...
true ? ButtonUnstyled.propTypes = {
   ...
   * @ignore
   */
  to: import_prop_types19.default.string
} : void 0;
...
function useControllableReducer(internalReducer, externalReducer, props) {
  ...
  const dispatchWithProps = React34.useCallback((action) => {
    dispatch(_extends({
      props: props.current
    }, action));
  }, [dispatch, props]);
...
function useListbox(props) {
  ...
  const defaultIdGenerator = React37.useCallback((_, index) => `${id}-option-${index}`, [id]);
  ...
  const createHandleOptionClick = React37.useCallback((option, other) => (event) => {
    var _other$onClick;
  ...
  const createHandleOptionPointerOver = React37.useCallback((option, other) => (event) => {
  ...
  const getOptionState = React37.useCallback((option) => {
    let selected;
  ...
  const getOptionTabIndex = React37.useCallback((optionState) => {
    if (focusManagement === "activeDescendant") {
      return void 0;
    }
  ...
  const getOptionProps = React37.useCallback((option, otherHandlers = {}) => {
...
function useMenuChangeNotifiers() {
  ...
  const notifyHighlightChanged = React39.useCallback((newValue) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newValue);
  }, [messageBus]);
  const registerHighlightChangeHandler = React39.useCallback((handler) => {
...
function useMenu(parameters = {}) {
  ...
  const getItemState = React40.useCallback((id) => {
    const {
      disabled,
      highlighted
    } = getOptionState(id);
...
var Portal = React41.forwardRef(function Portal2(props, ref) {
  ...
  const handleRef = useForkRef(React41.isValidElement(children) ? children.ref : null, ref);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime21.jsx)(React41.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime21.jsx)(React41.Fragment, {
...
true ? MenuUnstyled.propTypes = {
   ...
   * @ignore
   */
  listboxId: import_prop_types26.default.string,
  /**
...
var _excluded18 = ["children", "closeAfterTransition", "component", "container", "disableAutoFocus", "disableEnforceFocus", "disableEscapeKeyDown", "disablePortal", "disableRestoreFocus", "disableScrollLock", "hideBackdrop", "keepMounted", "manager", "onBackdropClick", "onClose", "onKeyDown", "open", "onTransitionEnter", "onTransitionExited", "slotProps", "slots"];
...
var ModalUnstyled = React47.forwardRef(function ModalUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsx)(
    Portal_default,
    {
      ...
      children: (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
        children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime25.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime25.jsx)(FocusTrap_default, {
          disableEnforceFocus,
          disableAutoFocus,
          disableRestoreFocus,
...
function useSelectChangeNotifiers() {
  const messageBus = useMessageBus();
  const notifySelectionChanged = React48.useCallback((newValue) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newValue);
  }, [messageBus]);
  const notifyHighlightChanged = React48.useCallback((newValue) => {
...
function useSelect(props) {
  ...
  const optionsMap = React49.useMemo(() => {
  ...
  const createHandleListboxItemClick = React49.useCallback((otherHandlers) => (event) => {
    var _otherHandlers$onClic2;
  ...
  const listboxReducer = React49.useCallback((state, action) => {
    const newState = defaultListboxReducer(state, action);
  ...
  const optionValues = React49.useMemo(() => options.map((o) => o.value), [options]);
  let useListboxParameters;
  const isOptionDisabled = React49.useCallback((valueToCheck) => {
  ...
  const getOptionProps = React49.useCallback((optionValue, otherHandlers = {}) => {
...
function getOptionsFromChildren(children) {
  ...
  React50.Children.forEach(children, (node2) => {
...
function defaultRenderMultipleValues(selectedOptions) {
  return (0, import_jsx_runtime27.jsx)(React52.Fragment, {
...
var MultiSelectUnstyled = React52.forwardRef(function MultiSelectUnstyled2(props, forwardedRef) {
  ...
  const context = React52.useMemo(() => _extends({}, contextValue, {
    listboxRef
  }), [contextValue]);
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React53.Fragment, {
...
var OptionGroupUnstyled = React54.forwardRef(function OptionGroupUnstyled2(props, ref) {
  const {
    component,
    disabled = false,
    slotProps = {},
...
var OptionUnstyled = React56.forwardRef(function OptionUnstyled2(props, ref) {
  const {
    children,
    component,
    disabled = false,
  ...
  const selectContext = React56.useContext(SelectUnstyledContext);
  if (!selectContext) {
...
var OptionUnstyled_default = React56.memo(OptionUnstyled);
...
var SelectUnstyled = React57.forwardRef(function SelectUnstyled2(props, forwardedRef) {
  var _ref, _slots$listbox, _slots$popper;
  const {
    autoFocus,
    children,
  ...
  const [groupedOptions, setGroupedOptions] = React57.useState([]);
  const options = React57.useMemo(() => flattenOptionGroups(groupedOptions), [groupedOptions]);
  const [listboxOpen, setListboxOpen] = useControlled({
    controlled: listboxOpenProp,
    default: defaultListboxOpen,
    name: "SelectUnstyled",
  ...
  const handleOpenChange = React57.useCallback((isOpen) => {
    setListboxOpen(isOpen);
    onListboxOpenChange == null ? void 0 : onListboxOpenChange(isOpen);
  }, [setListboxOpen, onListboxOpenChange]);
  const {
  ...
  const selectedOption = React57.useMemo(() => {
    var _options$find;
...
var _excluded25 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "component", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var SliderUnstyled = React59.forwardRef(function SliderUnstyled2(props, ref) {
...
var SnackbarUnstyled = React61.forwardRef(function SnackbarUnstyled2(props, ref) {
  const {
    autoHideDuration = null,
    children,
    component,
  ...
  return (0, import_jsx_runtime37.jsx)(ClickAwayListener_default, _extends({}, clickAwayListenerProps, {
...
var SwitchUnstyled = React63.forwardRef(function SwitchUnstyled2(props, ref) {
...
function LastPageIconDefault() {
  return _span || (_span = (0, import_jsx_runtime40.jsx)("span", {
    children: "⇾|"
  }));
}
...
var TablePaginationActionsUnstyled = React64.forwardRef(function TablePaginationActionsUnstyled2(props, ref) {
...
var TablePaginationUnstyled = React65.forwardRef(function TablePaginationUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime43.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime42.jsx)(Select, _extends({}, selectProps, {
...
function useTabs(parameters) {
  ...
  const onSelected = React66.useCallback((e, newValue) => {
    setValue(newValue);
    if (onChange) {
      onChange(e, newValue);
    }
...
var Context = React67.createContext(null);
if (true) {
  Context.displayName = "TabsContext";
}
function useTabContext() {
  return React67.useContext(Context);
}
...
var TabsUnstyled = React68.forwardRef((props, ref) => {
  var _ref;
  const {
    children,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime44.jsx)(TabsRoot, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime44.jsx)(TabsContext_default.Provider, {
...
var TabPanelUnstyled = React69.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
function useTabsList(parameters) {
  ...
  const tabsListRef = React70.createRef();
  ...
  const processChildren = React70.useCallback(() => {
    const valueToIndex = /* @__PURE__ */ new Map();
    let childIndex = 0;
    const processedChildren = React70.Children.map(children, (child) => {
...
var TabsListUnstyled = React71.forwardRef((props, ref) => {
  var _ref;
  const {
    component,
    slotProps = {},
  ...
  return (0, import_jsx_runtime46.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
...
var TabUnstyled = React72.forwardRef(function TabUnstyled2(props, ref) {
  var _ref;
  const {
    action,
    children,
...
var TextareaAutosize = React73.forwardRef(function TextareaAutosize2(props, ref) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const renders = React73.useRef(0);
  const [state, setState] = React73.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React73.useCallback(() => {
...
var Typography = React75.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_m_default(classes.root, className)
